...
const User = ({ username, email, userImage }) => {
  return (
    <div className="page-container-review w-full z-10 p-5 border-l border-[#24252A] cursor-pointer flex-1">
      <div className="flex items-start flex-col justify-between gap-x-2 bg-[#f36a63] py-3 px-2 rounded-2xl h-full">
        ...
        <div className="w-full">
          <div className="grid grid-cols-4 gap-x-2">
            <div className="item-social flex items-center justify-center p-2 rounded-lg bg-[#f08b86] hover:-translate-y-2 transition-all">
              <svg
        ...
        <div className="flex items-center justify-between w-full">
          <div className="flex gap-x-3 items-center">
            <div className="p-2 rounded-full flex items-center justify-center bg-[#fa8f89]">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6"
                viewBox="0 0 20 20"
          ...
          <div>
            <ButtonSecondary
              ...
              iconClassName={"text-[#191A1F] w-5 h-5"}></ButtonSecondary>
          </div>
        </div>
      </div>
    </div>
